...
if (isset($_POST['delete-podcasts'])) {
    $id = $_POST['podcast_id'];
    $admin->deletePodcasts($id);
}
...
<head>
    ...
    <style>
        ...
        .list:nth-of-type(9) .link:nth-of-type(1) {
            ...
            <div class="table-container">
                ...
                <table class="table" id="table_id">
                    ...
                    <tbody class="action">
                        ...
                        <?php
                        $data = $admin->displayPendingPodcasts('accepted', '', $start_from, $num_per_page);
                        $count = $start_from + 1;
                        foreach ($data as $row) {
                        ...
                        <div class="modal-content">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="delete-podcasts" class="btn btn-primary">Yes</button>
                                </div>
                            </form>
                ...
                <div class="pagination">
                    <?php
                    $data = $admin->displayPendingPodcasts('accepted', "all");
