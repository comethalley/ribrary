...
if (isset($_POST['delete-docs'])) {
    $id = $_POST['doc_id'];
    $admin->deleteDocuments($id);
}
            ...
            <div class="table-container">
                ...
                <table class="table" id="table_id">
                    ...
                    <tbody class="action">
                        ...
                        <?php
                        $data = $admin->displayUploadedDocuments('accepted', '', $start_from, $num_per_page);
                        $count = $start_from + 1;
                        foreach ($data as $row) {
                        ...
                        <div class="modal-content">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="delete-docs" class="btn btn-primary">Yes</button>
                                </div>
                            </form>
                ...
                <div class="pagination">
                    <?php
                    $data = $admin->displayUploadedDocuments('accepted', "all");
