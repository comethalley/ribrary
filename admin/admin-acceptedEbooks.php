...
if (isset($_POST['delete-ebooks'])) {
    $id = $_POST['ebooks_id'];
    $admin->deleteEbooks($id);
}
...
<head>
    ...
    <style>
        ...
        .list:nth-of-type(11) .link:nth-of-type(1) {
            ...
            <div class="table-container">
                ...
                <table class="table" id="table_id">
                    ...
                    <tbody class="action">
                        ...
                        <?php
                        $data = $admin->displayPending('accepted', 'tbl_ebooks', '', $start_from, $num_per_page);
                        $count = $start_from + 1;
                        foreach ($data as $row) {
                        ...
                        <div class="modal-content">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="delete-ebooks" class="btn btn-primary">Done</button>
                                </div>
                            </form>
                ...
                <div class="pagination">
                    <?php
                    $data = $admin->displayPending('accepted', "tbl_ebooks", "all");
