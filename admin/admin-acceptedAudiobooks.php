...
if (isset($_POST['delete-audiobook'])) {
    $id = $_POST['audiobook_id'];
    $admin->deleteAudiobooks($id);
}
...
<head>
    ...
    <style>
        ...
        .list:nth-of-type(10) .link:nth-of-type(1) {
...
<body>
            ...
            <div class="table-container">
                ...
                <table class="table" id="table_id">
                    ...
                    <tbody class="action">
                        ...
                        <?php
                        $data = $admin->displayPendingAudiobooks('accepted', '', $start_from, $num_per_page);
                        $count = $start_from + 1;
                        foreach ($data as $row) {
                        ...
                        <div class="modal-content">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" name="delete-audiobook" class="btn btn-primary">Yes</button>
                                </div>
                            </form>
                ...
                <div class="pagination">
                    <?php
                    $data = $admin->displayPendingAudiobooks('accepted', "all");
    ...
    <script>
        ...
        if (success && success == 'DeleteSuccess') {
