...
<head>
    ...
    <title>Pending AudioBooks</title>
    ...
    <style>
        ...
        .list:nth-of-type(6) .link:nth-of-type(1) {
                ...
                <table class="table" id="table_id">
                    ...
                    <thead>
                        <tr class="table-header">
                            <th scope="col">No.</th>
                            <th scope="col">Audiobook Name</th>
                            <th scope="col">Audiobook File</th>
                            <th scope="col">Audiobook Cover</th>
                    ...
                    <tbody class="action">
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td> <?php echo $row["audiobook_name"] ?></td>
                                <td><audio controls src="../functions/uploads/<?php echo $row['audiobook_path'] ?>"></audio></td>
                                <td><a href='../functions/uploads/<?php echo $row["audiobook_cover_path"] ?>' target="_thapa">View</a></td>
                                <td> <?php echo $row["categories"] ?></td>
                                <td> <?php echo $row["date_and_time"] ?></td>
                                <td> <?php echo $row["uploaded_by"] ?></td>
                                <td>
                                    <input type="hidden" name="audiobook_id" value="<?php echo $row["audiobook_id"] ?>">
                ...
                <div class="modal fade" id="acceptModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="../functions/admin-pendingAudiobooks-function.php" method="POST">

                                <!-- DISPLAY -->
                                <div class="modal-body">

                                    <input type="hidden" name="audiobook_id" id="audiobook_id_accept">
                                    Are you sure you want to accept?
                                </div>

                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                    <button type="submit" name="accept-audiobook" class="btn btn-primary">Yes</button>
                                </div>
                            </form>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="../functions/admin-pendingAudiobooks-function.php" method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="hidden" name="audiobook_id" id="audiobook_id_decline1">
                                    Are you sure you want to decline?
                                </div>

                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                    <button type="submit" name="decline-audiobook" class="btn btn-primary">Done</button>
                                </div>
                            </form>
    ...
    <script>
        ...
        action.addEventListener('click', function(e) {
            if (e.target.classList.contains('acceptBtn')) {
                ...
                document.querySelector('#audiobook_id_accept').value = docId;
                // console.log(docId)
            }
            ...
            if (e.target.classList.contains('declineBtn')) {
                ...
                const docId = e.target.closest('td').firstElementChild.value
                document.querySelector('#audiobook_id_decline1').value = docId;
                // console.log(docId)
            }
        })
