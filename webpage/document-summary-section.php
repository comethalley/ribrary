...
if (isset($_GET['doc_file'])) {
  ...
  $doc_data = $user->getDocuData($doc_file);
}
  ...
  <main>
    ...
    <main>
      <div class="container1 mx-auto my-5 p-2">
        <div class="row my-3">
          <div class="col-md-12">
            <img src="img/book-icon.png" class="img-thumbnail mx-auto d-block" alt="cover" style="width:400px; height:300px;">
          </div>
        </div>
        <div class="row">
          <div class="col-md-9 mx-auto">
            <div class="card" style="width: 100%">
              <div class="card-body">
                <h5 class="card-title"><?php echo $doc_data['doc_name'] ?></h5>
                <p class="card-text">Abstract: <?php echo $doc_data['abstract'] ?></p>
              </div>
              <form action="view.php" method="GET">
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">Ratings</li>
                  <li class="list-group-item">Author: <?php echo $doc_data['createdBy'] ?></li>
                  <li class="list-group-item">Categories: <?php echo $doc_data['categories'] ?></li>
                </ul>
