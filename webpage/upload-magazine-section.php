...
<header>
  ...
  <div class="uploadfile">
    <h2>Welcome to Magazine Upload Page!</h2>
	...
	(Please note that Magazines are the only files allowed to be uploaded), Then click "Upload".</p>
	
	<br>
	<form action="../functions/upload-magazine-function.php" method = "POST" enctype="multipart/form-data">
